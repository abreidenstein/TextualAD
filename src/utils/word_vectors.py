...
def load_word_vectors(word_vectors_name, embedding_size, word_vectors_cache='../data/word_vectors_cache'):
    ...
    implemented_vector_embeddings = ('GloVe_6B', 'GloVe_42B', 'GloVe_840B', 'GloVe_twitter.27B', 'FastText_en', 'FastText_fr','Electra_pretrained')
    ...
    if word_vectors_name == 'FastText_fr':
        embedding_size = 300
        word_vectors = FastText(language='fr', cache=word_vectors_cache)
